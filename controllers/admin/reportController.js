...
module.exports = {
    salesReport: async (req, res) => {
        try {
            ...
            return res.render('admin/report/salesReport', { headerColumns, data, from, to });
        } catch (err) {
    ...
    taxReport: async (req, res) => {
        try {
            ...
            return res.render('admin/report/taxReport', { headerColumns, data, from, to });
        } catch (err) {
            return helper.error(res, err);
        }
    },
    totalIncomeReport: async (req, res) => {
        try {
            ...
            return res.render('admin/report/totalIncomeReport', { headerColumns, data, from, to });
        } catch (err) {
            return helper.error(res, err);
        }
    },

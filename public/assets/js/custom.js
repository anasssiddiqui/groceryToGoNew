...
$(function() {
    ...
    */
    ...
    /*
    |------------------------------------------------------------------------------------------------------------------------------------------
    |   Change Today Category Item Status
    |------------------------------------------------------------------------------------------------------------------------------------------
    |
    */
    $(document.body).on('change', '.changeTodayCategoryItem', function() {
        const id = $(this).attr('model_id');
        const model = $(this).attr('model');
        const modelTitle = $(this).attr('model_title');
            ...
            $.ajax({
                ...
                success: (response) => {
                    ...
                    setTimeout(() => {
                        ...
                        iziToast[response.success ? 'success' : 'error']({
                            // title: response.message,
                            title: `Today\'s ${modelTitle} Category Item changed to ${statusText}`,
                            // message: '',
                            position: 'topRight'
                        });
                    }, 500);
    ...
    */
    ...
    $(document.body).on('submit', '#changePasswordSettingForm', function(e) {
        ...
        $.ajax({
            url: '/admin/user/changePasswordSetting',
            data: formData,
            processData: false,
            contentType: false,
            type: 'POST',
    ...
    $(document.body).on('submit', '#changeEmailSettingForm', function(e) {
        ...
        $.ajax({
            url: '/admin/user/changeEmailSetting',
            data: formData,
            processData: false,
            contentType: false,
            type: 'POST',
    ...
    */
    $(document.body).on('change', '#productCategorySelect', function() {
        ...
        $.ajax({
            url: '/admin/product/productCategorySelect',
            data: {
    ...
    */
    ...
    |
    */
    $(document.body).on('click', '.add_recipe_ingredient', function() {
        let html = ``;
    ...
    $(document.body).on('click', '.delete_recipe_ingredient_row', function(e) {
        e.preventDefault;
    ...
    */
    ...
    /*
    |------------------------------------------------------------------------------------------------------------------------------------------
    | Product Cascading Category Select Boxes
    |------------------------------------------------------------------------------------------------------------------------------------------
    |
    */
    ...
    $(document.body).on('submit', '#selectProductCategory', function(e) {
        ...
        $('#productAddEditForm').removeClass('hiddenform');
